...
exports.getPostscriptName = void 0;
const plist = require("plist");
const shelljs = require("shelljs");
const fs = require("fs");
const path = require("path");
async function getPostscriptName(path) {
    try {
...
exports.getPostscriptName = getPostscriptName;
if (require.main === module) {
    (async () => {
        ...
        if (!process.env.INFOPLIST_FILE)
            throw new Error(`INFOPLIST_FILE missing`);
        const plistOrig = fs.readFileSync(process.env.INFOPLIST_FILE).toString('utf8');
        const plistObj = plist.parse(plistOrig);
...
//# sourceMappingURL=fontlink.js.map