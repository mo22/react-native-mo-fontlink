...
if (require.main === module) {
  (async () => {
    ...
    await fs.promises.writeFile(
      path.join(resDir, 'font', 'pitchsans_medium.otf'),
      await fs.promises.readFile('/Users/mmoeller/workspace/straiqr/phiber-app/assets/fonts/PitchSans-Medium.otf'),
    );
    ...
    await fs.promises.writeFile(
      ...
      `<resources><string name="xxxtest">value</string></resources>\n`
    );
